...
def main():
    ...
    print(court_1)
    print("==========================")
    stadium_1 = Stadium(68, 150, "Słoneczna 10, 10-100 Olsztyn", 1999, "Słoneczny stadion", 10000, "Słoneczko")
    print(stadium_1)
    print("==========================")
    stadium_2 = Stadium(68, 150, "Słoneczna 10, 10-100 Olsztyn", 1999, "Słoneczny stadion", 10000)
    print(stadium_2)
    print("==========================")
